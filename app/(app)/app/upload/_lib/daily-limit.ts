...
// submit-upload.ts(単一 invocation 経路の sync tx 内 cap 判定)の両方がここから import
...
//
// directive 無し(sync 関数を export するため)。Next.js の "use server"
// transform は非 async 関数の export を compile error にする
// (T4 の asset-limits.ts 切り出しと同じ制約)。
