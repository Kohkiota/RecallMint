...
| P3 | client 側 use-case 化(タグ CRUD 移設 / card write 集約 / side peek 複製解消 / runOptimistic* 昇格 / inline primitive 統合) | plan 確定 | — | 着手時 `aeb4d23` 再スキャン済(audit 主張ほぼ全数一致・乖離 2 = V3 正規化は 1 箇所実体〈分散集約に補正〉/ 「安全網最薄」は components/ の数字で P3 対象 11 file は co-located test 現存〈characterization は監査+差分追加の 2 段に再定義〉。詳細 = docs/superpowers/sessions/2026-07-07-ddd-p3-factfinding.md) |
